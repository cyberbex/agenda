...
async userExists(){
 ...
 cleanUp(){
  //conferi se tem alguma coisa diferente de string no formulário 
  for(const key in this.body){
   ...
   //garante que o objeto, so vai conter email e password(campos), retirando o Token por exemplo!!
   this.body = {
